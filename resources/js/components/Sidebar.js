    ...
    return (
        <div className="h-screen flex overflow-hidden bg-gray-100">
            ...
            <div className="container ">
                <button onClick={toggleSidebar} className="mt-4 -ml-4 h-10 w-10 bg-blue-600 rounded-r-full text-white focus:bg-blue-900 hover:bg-blue-800 md:hidden" aria-label="Open sidebar">
